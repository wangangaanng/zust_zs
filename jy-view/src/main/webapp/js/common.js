...
var data={nav:[
    {url:'',title:'首页'},
    {url:'',title:'学院概况',sub:[{url:'',title:'学校简介'},{url:'',title:'学院专业'},{url:'',title:'中心介绍'}]},
    {url:'',title:'新闻公告',sub:[{url:'',title:'通知公告'},{url:'',title:'新闻快递'},{url:'',title:'校内公示'}]},
...
var headerPart={navList:"{{#nav}}<li>{{title}}<ul class='subnav'>{{>subnavList}}</ul></li>{{/nav}}",subnavList:"{{#sub}}<li><a href='#'><span>{{title}}</span></a></li>{{/sub}}"}
