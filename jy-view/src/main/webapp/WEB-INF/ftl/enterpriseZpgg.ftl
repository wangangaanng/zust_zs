            ...
            <div class="content-list">
                <div class="search-bar">
                    <div class="input-group search-input">
                        <input type="text" id="zwbt-zw" onkeydown="keyLogin()" class="form-control" placeholder="输入名称进行查询">
                        <div class="input-group-btn">
                            <button type="button" onclick="searchZw()" class="btn btn-default green"><span class="glyphicon glyphicon-search"></span></button>
                        </div>
                    </div>
                    <button class="btn pull-right green" onclick='addZpgg()'>点击新增招聘公告</button>
                </div>
                <div class="news-list">
...
<input type="hidden" id="curProv" value="${(result.qyProv)!''}">
<input type="hidden" id="curCity" value="${(result.qyCity)!''}">
