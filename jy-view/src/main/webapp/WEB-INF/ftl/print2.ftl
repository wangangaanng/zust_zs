...
<div class="page">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table1">
            ...
            <tr>
                <td class="p15 bgc" rowspan="${listSize}" colspan="6">股权结构</td>
            ...
            <tr>
                <td class="p15 bgc" colspan="6" >前两个年度和最近一期财务数据
                    （单位：万元）</td>
                <td colspan="24" style="padding: 0 !important;border-left: none !important;border-bottom: none !important;">
                    <table class="table-bordered table2" style="width: 100%;border: none;">
                        <tbody style="border: none;">
                        <tr style="border-left: none !important;border-top: none !important;">
                            <td colspan="6" class="bgc" style="border-left: none !important;border-top: none !important;">年   度</td>
                            <td colspan="6" class="bgc" style="border-top: none !important;">2016年</td>
                            <td colspan="6" class="bgc" style="border-top: none !important;">2017年</td>
                            <td colspan="6" class="bgc" style="border-top: none !important;">2018年</td>
                        </tr>
                        <tr style="border-left: none !important;">
                            <td colspan="6" class="bgc" style="border-left: none !important;">总资产</td>
                        ...
                        <tr style="border-left: none !important;">
                            <td colspan="6" class="bgc" style="border-left: none !important;">净资产</td>
                            <td colspan="6" class="td-input">
                            ${dataBean.jzc1!''}
                            </td>
                            <td colspan="6" class="td-input">
                        ...
                        <tr style="border-left: none !important;">
                            <td colspan="6" class="bgc" style="border-left: none !important;">主营业务收入</td>
                            <td colspan="6" class="td-input">
                            ${dataBean.zysr1!''}
                            </td>
                            <td colspan="6" class="td-input">
                        ...
                        <tr style="border-left: none !important;">
                            <td colspan="6" class="bgc" style="border-left: none !important;">净利润</td>
                            <td colspan="6" class="td-input">
                            ${dataBean.jlr1!''}
                            </td>
                            <td colspan="6" class="td-input">
                        ...
                        <tr style="border-left: none !important;border-bottom: none !important;">
                            <td colspan="6" class="bgc" style="border-left: none !important;border-bottom: none !important;">经营现金净流量</td>
                            <td colspan="6" class="td-input" style="border-bottom: none !important;">
                            ${dataBean.xxjll1!''}
                            </td>
                            <td colspan="6" class="td-input" style="border-bottom: none !important;">
                            ${dataBean.xxjll2!''}
