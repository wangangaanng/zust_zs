            ...
            <div class="content-list" style="height: auto;">
                <form class="form-horizontal" style="padding-top: 20px;" id="registerForm" method="" action="" target="rfFrame">
                    <div class="form-group">
                        ...
                        <label for="qyTysh" class="col-sm-2 control-label">学号：</label>
                        <div class="col-sm-3">
                            <#if stuInfo.xh??>
                    ...
                    <div class="form-group">
                        <label for="ksh" class="col-sm-2 control-label">考生号：</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <label for="ssxx" class="col-sm-2 control-label">所属学校：</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <label for="xxzy" class="col-sm-2 control-label">学校专业：</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <label for="dzyx" class="col-sm-2 control-label">电子邮箱：</label>
                        <div class="col-sm-3">
