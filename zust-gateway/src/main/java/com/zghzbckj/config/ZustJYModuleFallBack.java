 ...
 */
@Component
public class ZustJYModuleFallBack implements FallbackProvider {
    ...
    public ClientHttpResponse fallbackResponse(String s, Throwable throwable) {
        return new ZustJYModuleFallBack.ResponseBack(s + ":=" + throwable.getMessage());
    }
