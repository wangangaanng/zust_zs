 ...
 */
@Component
public class ZustSWYTModuleFallBack implements FallbackProvider {

    @Override
    public String getRoute() {
        return "zustSWYTModule";
    }

    @Override
    public ClientHttpResponse fallbackResponse(String s, Throwable throwable) {
        return new ZustSWYTModuleFallBack.ResponseBack(s + ":=" + throwable.getMessage());
    }
