...
//            if ('WebSocket'in window) {
                ws= new WebSocket("ws://localhost:8080/ourway-api/webSocketServer");
//            }else {
//                ws = new SockJS("http://localhost:8080/ourway-api/webSocketServer/sockjs");
//            }
...
<div>
    <div id="connect-container">
        ...
        <br>
        <input id="radio2"type="radio"name="group1"onclick="updateUrl('/webSocketServer/sockjs/websocket');">
