...
public class JyContant {
    ...
    public static final String NOCOMP_ERROR_MESSAGE = "查无此企业信息,请注册";
    public static final String SH_ERROR_MESSAGE = "密码输入有误";
    ...
    public static final String QY_PASS_MESS = "恭喜您，您注册的公司已通过审核。您的登录名：";
    ...
    public static final String ZWMESS = "现场发放展位号";
}