...
public class BckjBizQyxx extends DataWithExpEntity<BckjBizQyxx> {
    ...
    public String getQyGsxzStr() {
        return qyGsxzStr;
    }

    public void setQyGsxzStr(String qyGsxzStr) {
        this.qyGsxzStr = qyGsxzStr;
    }

    public String getQyHylbStr() {
        return qyHylbStr;
    }

    public void setQyHylbStr(String qyHylbStr) {
        this.qyHylbStr = qyHylbStr;
    }

    public String getQyGsgmStr() {
        return qyGsgmStr;
    }

    public void setQyGsgmStr(String qyGsgmStr) {
        this.qyGsgmStr = qyGsgmStr;
    }
