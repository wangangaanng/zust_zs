...
public class SwytConstant {
    ...
    //state=1
    public static final String BMXZ = "报名表下载";
    //state=2
    public static final String BMPZSC = "报名表承诺书拍照上传";
    //state=3
    ...
    //state=8
    public static final String BMXZMSD = "面试已分配";
    //state=9
    public static final String XZMSD = "下载面试单";
    //state=10
