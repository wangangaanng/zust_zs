...
public class BckjBizLntj extends DataWithExpEntity<BckjBizLntj> {
	...
	private Custom zgf;		// zgf
	private Custom zdf;		// zdf
	private Custom pjf;		// pjf
	...
	public Custom getZgf() {
		return zgf;
	}

	public void setZgf(Custom zgf) {
		this.zgf = zgf;
	}
	...
	public Custom getPjf() {
		return pjf;
	}

	public void setPjf(Custom pjf) {
		this.pjf = pjf;
	}
