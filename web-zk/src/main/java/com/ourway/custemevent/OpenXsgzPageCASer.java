...
public class OpenXsgzPageCASer extends com.ourway.base.zk.main.MainAction implements ComponentListinerSer {
    public OpenXsgzPageCASer() {
    }
        ...
        if (TextUtils.isEmpty(windowParams)) {
            ...
            if (TextUtils.isEmpty(_params.get("attr"))) {
                ...
                if (null != datas && datas.size() > 1) {
                    ...
                    String zwbt = data.get("zwbt").toString();
                    ...
                    try {
                        ...
                        root.openFunByPageCa("职位-" + _params.get("title") + ":" + zwbt, pageCa, 4);
