 ...
 * </ul>
 */
public class CxfpAction implements ComponentListinerSer {
    ...
    public void doAction(BaseWindow window, Event event, PageControlVO pgvo) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(params.get("apiUrl")) && !AlterDialog.corfirm("确定重新分配面试时间，重新分配后，报名单的状态将会回退到面试未分配状态，请谨慎操作")) {
                return;
            }
            //调用接口
