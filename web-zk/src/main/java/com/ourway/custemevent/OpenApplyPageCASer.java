...
public class OpenApplyPageCASer extends com.ourway.base.zk.main.MainAction implements ComponentListinerSer {
    public OpenApplyPageCASer() {
    }
            ...
            if (TextUtils.isEmpty(_params.get("attr"))) {
                ...
                if (null != datas && datas.size() > 1) {
                    ...
                    try {
                        ...
                        root.openFunByPageCa(zwbt + "报名表", pageCa, 4);
