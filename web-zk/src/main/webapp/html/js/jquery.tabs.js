        ...
        Tabs:function(options){
            ...
            var tabHandle = function( elem ){
                    ...
                    tabBox.siblings( 'div' )
                        ...
                        .eq( elem.index() )
                        .removeClass( 'hide' );
                    var type = elem.attr("val");
                    if(!$("."+type).find("ul").html()){
                        ajaxPost("companyIndexApi/listNewsByType.do",{"type":type},1,"",type);//通知公告类型
                    }
                },
                ...
                autoRun = function(){
                    var current = menu.find( 'li.current' ),//第几个tab头
                        firstItem = items.eq(0),//第一个li
                        len = items.length,
