<div sclass="navbar" apply="main.NavbarComposer" style="background-color: #438EB9;">
	<!-- Brand Logo -->
	<a label="ZK Admin " sclass="pull-left navbar-brand" iconSclass="z-icon-leaf" style="color:#ffffff"/>
	<!-- Navbar -->
	...
	<popup id="notipp" sclass="menu menu-pink" width="240px">
			<a label="8 Notifications" sclass="header" iconSclass="z-icon-exclamation-triangle"/>
			<vlayout spacing="0">
