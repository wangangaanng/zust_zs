...
<window
	...
	use="com.ourway.base.zk.template.TreeTemplatePagesAction">
    <custom-attributes caname="/template/leftTreeTemplatePages.do" />
    <borderlayout id="bdLayout">
        <west id="westLayout" size="190px" flex="true" splittable="true" collapsible="true">
           <div align="left">
