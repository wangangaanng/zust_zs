...
<window
	...
	use="com.ourway.base.zk.template.TreeTemplateFormGridAction">
    <custom-attributes caname="/template/leftTreeFormGrid.do" />
    <borderlayout id="bdLayout">
        <west id="westLayout" size="160px" flex="true" splittable="true" collapsible="true">
           <div align="left">
          ...
          <vbox>
            ...
            <!-- 主表区 -->
                ...
                <panel id="dataListGroupboxCaption"  sclass="panel-primary" collapsible="true" style="margin-top: -2px;">
            	   <panelchildren>
            	       <div  id="dataListHeader" class="container-fluid dataListHeader"  >
