...
public class CommonConstant {
     ...
     * 系统常量
     */
    public static final String ERROR_SYS_MESSAG = "系统遇到错误，请联系管理员！";
    public static final String SUCCESS_MESSAGE = "操作成功！";
    public static final String FAIL_MESSAGE = "操作失败！";
    public static final String ERROR_NOPARAMS = "传参为空！";
    ...
    public static final String PasswordError = "密码错误或账号错误";
